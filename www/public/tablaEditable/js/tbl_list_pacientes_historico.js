...
//            var estado = grid.getValueAt(cell.rowIndex, 3);
            ...
            menu += '<li><a href="' + urlBase + '/pacientes/expedientehistoricoa/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-clipboard-list-check text-secondary"></span> Historial</a></li>';
