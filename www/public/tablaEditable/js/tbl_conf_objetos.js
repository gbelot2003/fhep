...
//            var estado = grid.getValueAt(cell.rowIndex, 3);
            ...
            menu += '<li><a href="' + urlBase + '/objetos/editar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-pencil text-warning"></span> Modificar</a></li>';
            menu += '<li><a href="' + urlBase + '/objetos/eliminar/' + id + ' " class="btn btn-sm dropdown-item" ><span class="fa-light fa-trash-xmark text-danger"></span> Eliminar</a></li>';
