...
//            var estado = grid.getValueAt(cell.rowIndex, 3);
            ...
            menu += '<li><a href="' + urlBase + '/pacientes/expedientemedico/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-file-signature text-warning "></span> Gestionar</a></li>';
           menu += '<li><a href="javascript:cambiarEstado(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Cambiar Estado de Cita</a></li>';
            menu += '<li><a href="' + urlBase + '/pacientes/activar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-eye text-primary"></span> Ver</a></li>';
