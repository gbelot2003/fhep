...
//            var identidad = grid.getValueAt(cell.rowIndex, 1);
            var estado = grid.getValueAt(cell.rowIndex, 5);
            var especialidad = grid.getValueAt(cell.rowIndex, 4);
...
//            menu += '<li><a href="' + urlBase + '/pacientes/preclinica/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-file-signature text-success "></span> Preclinear</a></li>';

            if (estado === 'Precliniada' && especialidad === 'Medico General') {
                menu += '<li><a href="' + urlBase + '/pacientes/editarpreclinica/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-file-signature text-success "></span> Editar Preclinica</a></li>';
                menu += '<li><a href="javascript:cambiarMedico(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Reasignar Medico</a></li>';
                menu += '<li><a href="' + urlBase + '/citas/pdffichacitas/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir</a></li>';
            } else if (estado === 'Precliniada') {
                menu += '<li><a href="' + urlBase + '/pacientes/editarpreclinica/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-file-signature text-success "></span> Editar Preclinica</a></li>';
                menu += '<li><a href="' + urlBase + '/citas/pdffichacitas/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir</a></li>';
            } else if (estado === 'Nueva' && especialidad === 'Medico General') {
                menu += '<li><a href="javascript:cambiarMedico(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Reasignar Medico</a></li>';
                menu += '<li><a href="javascript:cambiarEstado(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Cambiar Estado de Cita</a></li>';
                menu += '<li><a href="' + urlBase + '/citas/pdffichacitas/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir</a></li>';
                menu += '<li><a href="' + urlBase + '/citas/eliminarcita/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-trash-xmark text-danger"></span> Eliminar</a></li>';
            } else if (estado === 'Nueva') {
                menu += '<li><a href="javascript:cambiarEstado(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Cambiar Estado de Cita</a></li>';
                menu += '<li><a href="' + urlBase + '/citas/pdffichacitas/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir</a></li>';
                menu += '<li><a href="' + urlBase + '/citas/eliminarcita/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-trash-xmark text-danger"></span> Eliminar</a></li>';
            } else if (especialidad !== 'Medico General' && estado !== 'Completada') {
                menu += '<li><a href="' + urlBase + '/citas/pdffichacitas/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir</a></li>';
                menu += '<li><a href="javascript:cambiarEstado(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Cambiar Estado de Cita</a></li>';
            } else {
                menu += '<li><a href="' + urlBase + '/citas/pdffichacitas/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir</a></li>';
