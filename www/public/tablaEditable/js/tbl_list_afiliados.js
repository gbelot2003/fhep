...
//            var nomb = grid.getValueAt(cell.rowIndex, 2);
            ...
            menu += '<button class="nav-link mx-auto dropdown-toggle  btn btn-sm bg-primary text-white" href="#" data-bs-toggle="dropdown">';
            menu += 'Opciones</button>';
            menu += '<ul class="dropdown-menu " >';
            menu += '<li><a href="' + urlBase + '/afiliados/editarafiliado/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-user-pen text-warning"></span> Editar Afiliado</a></li>';
            menu += '<li><a href="' + urlBase + '/afiliados/agregarbeneficiario/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-user-plus text-primary"></span> Agregar Beneficiario</a></li>';
            menu += '<li><a href=" javascript:creardoctor(\'' + id + '\'); " class="btn btn-sm dropdown-item" ><span class="fa-light fa-user-md text-primary"></span> Registrar Como Doctor</a></li>';
            menu += '<li><a href=" ' + urlBase + '/afiliados/verbeneficiarios/' + id + ' " class="btn btn-sm dropdown-item" ><span class="fa-light fa-eyes text-primary"></span> Ver Beneficiarios</a></li>';
            menu += '<li><a href="' + urlBase + '/afiliados/pdffichaafiliado/' + id + '" target="_blank" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir Ficha</a></li>';
            if (estado === 'Inactivo') {
                menu += '<li><a href="' + urlBase + '/afiliados/cambiarestadoafiliado/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-person-from-portal text-success"></span> Activar</a></li>';
            } else {
                menu += '<li><a href="' + urlBase + '/afiliados/cambiarestadoafiliado/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-person-to-portal text-danger"></span> Inactivar</a></li>';
            }
            menu += '<li><a href="' + urlBase + '/afiliados/eliminarafiliado/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-user-xmark text-danger"></span> Eliminar</a></li>';
    ...
    grid.renderGrid("divtabla", "table testgrid table-hover table-responsive table-bordered  table-striped", "tabla");
