...
//            var estado = grid.getValueAt(cell.rowIndex, 3);
            ...
            menu += '<li><a href="javascript:editarEst(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="bi bi-std-14 bi-pencil"></span> Modificar</a></li>';
            menu += '<li><a href="' + urlBase + '/mantenimientos/eliminarecivil/' + id + '" class="btn btn-sm dropdown-item" ><span class="bi bi-std-14 bi-x-circle text-danger"></span> Borrar</a></li>';
