...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadXML("/empleados/editarcelda");
};
...
//	})); 
	...
	grid.renderGrid("divtabla", "table table-hover table-responsive table-bordered table-sorting table-striped");
};    
...
function updatePaginator(grid, divId)
{
	...
	// "first" link
	var link = $("<a class='nobg'>").html("<i class=' fa fa-angle-left'><i class=' fa fa-angle-left'> Primero");
	...
	// "prev" link
	link = $("<a class='nobg'>").html("<i class=' fa fa-angle-left'> Atrás");
	if (!grid.canGoBack()) link.css({ opacity : 0.4, filter: "alpha(opacity=40)" });
	...
	// "next" link
	link = $("<a class='nobg'>").html("Siguiente <i class=' fa fa-angle-right'>");
	...
	// "last" link
	link = $("<a class='nobg'>").html("Último <i class=' fa fa-angle-right'><i class=' fa fa-angle-right'>");
	if (!grid.canGoForward()) link.css({ opacity : 0.4, filter: "alpha(opacity=40)" });
