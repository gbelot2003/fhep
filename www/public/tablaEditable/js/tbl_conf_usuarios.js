...
//            var identidad = grid.getValueAt(cell.rowIndex, 1);
            ...
            menu += '<li><a href="' + urlBase + '/usuarios/editar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-user-pen text-warning"></span> Modificar</a></li>';

//            if (estado === "Inactivo") {
//                menu += '<li><a href="' + urlBase + '/usuarios/activar/' + id + '" class="btn btn-sm dropdown-item" ><span class="bi bi-std bi-check-lg text-success"></span> Activar</a></li>';
//            } else if (estado === "Beneficiario") {
//                menu += '<li><a href="' + urlBase + '/usuarios/inactivar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-success"></span> Cambiar Estado</a></li>';
//            } else {
//                menu += '<li><a href="' + urlBase + '/usuarios/activar/' + id + '" class="btn btn-sm dropdown-item" ><span class="bi bi-std bi-check-lg text-success"></span> Activar</a></li>';
//                menu += '<li><a href="' + urlBase + '/usuarios/inactivar/' + id + '" class="btn btn-sm dropdown-item" ><span class="bi bi-std bi-x-circle text-danger"></span> Inactivar</a></li>';
//            }
            menu += '<li><a href="' + urlBase + '/usuarios/eliminar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-trash-xmark text-danger"></span> Eliminar</a></li>';
