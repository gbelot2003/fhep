...
var urlBase = "";
var urlUpdate = "";
function direcciones(urldata, urlbase, urlupdate) {
    urlData = urldata;
    urlBase = urlbase;
    urlUpdate = urlupdate;
}
...
//            var identidad = grid.getValueAt(cell.rowIndex, 1);
            ...
            menu += '<li><a href="' + urlBase + '/permisos/asinaciondepermisos/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-pencil text-warning"></span> Asignar Permisos</a></li>';
            menu += '<li><a href="' + urlBase + '/roles/editar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-pencil text-warning"></span> Editar</a></li>';
//            menu += '<li><a href="javascript:cambiarEstado(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Cambiar Estado</a></li>';
            menu += '<li><a href="' + urlBase + '/roles/eliminar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-trash-xmark text-danger"></span> Eliminar</a></li>';
