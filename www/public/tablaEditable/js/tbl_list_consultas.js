...
//            var identidad = grid.getValueAt(cell.rowIndex, 1);
            ...
            if (estado === "Precliniada") {
                menu += '<li><a href="' + urlBase + '/pacientes/expedientemedico/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-file-signature"></span> Gestionar</a></li>';
                menu += '<li><a href="' + urlBase + '/pacientes/expedientehistorico/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-clipboard-list-check text-secondary"></span> Historial</a></li>';
            } else {
...
//                menu += '<li><a href="javascript:cambiarEstado(\'' + id + '\');" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Cambiar Estado de Cita</a></li>';
//                menu += '<li><a href="' + urlBase + '/pacientes/verexpedientemedico/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-eye text-primary"></span> Ver</a></li>';
//                menu += '<li><a href="' + urlBase + '/pacientes/inactivar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir</a></li>';
//                menu += '<li><a href="' + urlBase + '/citas/eliminarcita/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-trash-xmark text-danger"></span> Eliminar</a></li>';
//                
//            } else {
//                menu += '<li><a href="' + urlBase + '/pacientes/expedientemedico/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-file-signature"></span> Gestionar</a></li>';
