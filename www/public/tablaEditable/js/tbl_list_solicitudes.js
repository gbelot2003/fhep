...
DatabaseGrid.prototype.initializeGrid = function (grid) {
    ...
    grid.setCellRenderer("opciones", new CellRenderer({
        render: function (cell, id) {
            ...
            menu += '<li><a href="' + urlBase + '/solicitudes/gestionarsolicitudes/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-file-signature text-warning "></span> Gestionar</a></li>';
            menu += '<li><a href="' + urlBase + '/solicitudes/cambiarEstado/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-arrow-down-arrow-up text-warning"></span> Cambiar Estado de cita</a></li>';
            menu += '<li><a href="' + urlBase + '/solicitudes/ver/' + id + '" class="btn btn-sm dropdown-item" ><span class="fas fa-eye text-primary"></span> Ver</a></li>';
            menu += '<li><a href="' + urlBase + '/solicitudes/imprimir/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-print text-success"></span> Imprimir</a></li>';
            menu += '<li><a href="' + urlBase + '/solicitudes/eliminar/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-trash-xmark text-danger"></span> Eliminar</a></li>';
