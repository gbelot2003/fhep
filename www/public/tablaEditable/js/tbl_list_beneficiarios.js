...
//            var identidad = grid.getValueAt(cell.rowIndex, 1);
            ...
            menu += '<li><a href="' + urlBase + '/afiliados/editarbeneficiario/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-pencil text-warning"></span> Editar Beneficiario</a></li>';
            if (estado === 'Inactivo') {
                ...
                menu += '<li><a href="' + urlBase + '/afiliados/cambiarestadoafiliado/' + id + '" class="btn btn-sm dropdown-item" ><span class="fa-light fa-person-to-portal text-danger"></span> Inacticar</a></li>';
            }
