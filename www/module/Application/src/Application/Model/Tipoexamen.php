...
class Tipoexamen extends TableGateway {

    private $dbAdapter;

    public function __construct(Adapter $adapter = null, $databaseSchema = null, ResultSet $selectResultPrototype = null) {
        $this->dbAdapter = $adapter;
        return parent::__construct('tbl_tipoexamen', $adapter, $databaseSchema, $selectResultPrototype);
    }
    ...
    public function getTblTipoexamen() {
    ...
    public function getExisteTipoexamen($id) {

        $SQL = "SELECT * "
                . "FROM tbl_datos_profecionales AS d "
                . "WHERE d.id_cod_tipoexamen = $id";

        $rs = $this->dbAdapter->query($SQL, Adapter::QUERY_MODE_EXECUTE);

        return $rs->toArray();
    }
       public function getTipoexamenInfo($id) {
