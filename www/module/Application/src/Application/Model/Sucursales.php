 ...
 * @Creado el : 12-abr-2022, 09:54:42 AM
 */
...
class Sucursales extends TableGateway {

    private $dbAdapter;

    public function __construct(Adapter $adapter = null, $databaseSchema = null, ResultSet $selectResultPrototype = null) {
        $this->dbAdapter = $adapter;
        return parent::__construct('tbl_sucursales', $adapter, $databaseSchema, $selectResultPrototype);
    }
...
//      } 
          ...
          public function getSucursales() {
             ...
             $SQL ="SELECT * "
                     . "FROM tbl_sucursales "
                     . "WHERE tbl_sucursales.estado = 1 "
                     . "ORDER BY tbl_sucursales.nombre_sucursal ASC " ; 
      ...
      public function getExisteUsuario($id) {
     
             $SQL ="SELECT * "
                     . "FROM tbl_ms_usuarios AS u "
                     . "WHERE u.id_sucursal = $id " ; 
      ...
      public function getExistenCitas($id) {
     
             $SQL ="SELECT c.* "
                     . "FROM tbl_cit_medicas AS c "
                     . "WHERE c.id_sucursal = $id " ; 
