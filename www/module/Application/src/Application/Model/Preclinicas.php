 ...
 * @Creado el : 23-mar-2022, 02:54:52 AM
 */
...
class Preclinicas extends TableGateway {

    private $dbAdapter;

    public function __construct(Adapter $adapter = null, $databaseSchema = null, ResultSet $selectResultPrototype = null) {
        $this->dbAdapter = $adapter;
        return parent::__construct('tbl_preclinica', $adapter, $databaseSchema, $selectResultPrototype);
    }
    ...
    /*
     ...
     public function getInfoPreclinica($id) {

        $SQL = "SELECT * "
                . "FROM tbl_preclinica "
                . "WHERE tbl_preclinica.id_cita = $id ";
