...
class Datosprofecionales extends TableGateway {

    private $dbAdapter;

    public function __construct(Adapter $adapter = null, $databaseSchema = null, ResultSet $selectResultPrototype = null) {
        $this->dbAdapter = $adapter;
        return parent::__construct('tbl_datos_profecionales', $adapter, $databaseSchema, $selectResultPrototype);
    }
    ...
    public function personalNuevo($data = array()) {
        return $this->insert($data);
    }

    public function actualizar($id, $data = array()) {
        return $this->update($data, array('id_persona' => $id));
    }

    public function borrar($id) {
        return $this->delete(array('id_persona' => $id));
    }
