 ...
 * @Creado el : 26-mar-2022, 04:13:47 AM
 */
...
class Expedientes extends TableGateway {

    private $dbAdapter;

    public function __construct(Adapter $adapter = null, $databaseSchema = null, ResultSet $selectResultPrototype = null) {
        $this->dbAdapter = $adapter;
        return parent::__construct('tbl_exp_clinico', $adapter, $databaseSchema, $selectResultPrototype);
    }
