 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', $_SESSION['directorioBase'].'/imagenespdf/');

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', 'logoRotario.png');

define ('PDF_HEADER_LOGO_BLANK', '_blank.png');
 ...
 * Document author.
 */
define ('PDF_AUTHOR', 'AMDC');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'AMDC');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Honduras, Tegucigalpa\n".date('Y'));
